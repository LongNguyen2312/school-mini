...
function ensureLookAnims(scene: Phaser.Scene, sheetKey: string) {
  ...
  mk('dance-up', PLAYER_FRAMES.walkUp, 14, -1)
  mk('dance-down', PLAYER_FRAMES.walkDown, 14, -1)
  mk('dance-left', PLAYER_FRAMES.walkLeft, 14, -1)
  mk('dance-right', PLAYER_FRAMES.walkRight, 14, -1)
